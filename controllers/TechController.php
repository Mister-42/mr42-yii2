...
class TechController extends Controller
{
		...
		return [
			...
			[
				...
				'lastModified' => function (Object $action, $params) {
					return filemtime(Yii::getAlias('@webroot/assets/images/'.Yii::$app->params['favicon']));
				},
			],
			[
				'class' => HttpCache::className(),
	...
	{
		Yii::$app->response->sendFile(Yii::getAlias('@webroot/assets/images/'.Yii::$app->params['favicon']), 'favicon.ico', ['inline' => true]);
	}
