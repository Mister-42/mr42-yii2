...
echo Html::beginTag('div', ['class' => 'row']);
    echo Html::beginTag('div', ['class' => 'col-md-12 col-lg-8 mx-auto']);
        ...
        echo Html::tag('div', Yii::t('mr42', 'This calculator calculates the new end date of a Microsoft® Office 365® Open SKU subscription. For redeeming your product keys, please visit {url}.', ['url' => Html::a('https://office.com/setup365', 'https://office.com/setup365', ['class' => 'alert-link'])]), ['class' => 'alert alert-info shadow']);

        if ($flash = Yii::$app->session->getFlash('office365-error')) {
            Alert::begin(['options' => ['class' => 'alert-danger shadow fade show']]);
            ...
            Alert::begin(['options' => ['class' => 'alert-success shadow']]);
        ...
        foreach (['source', 'target'] as $field) {
            ...
            echo $form->field($model, $field . 'count', [
                    'icon' => $field === 'source' ? 'user' : 'user-plus',
                    'options' => ['class' => 'form-group col-md-6'],
