...
switch ($action) :
	case 'tag'		:	$this->params['breadcrumbs'][] = ['label' => Yii::t('mr42', 'Articles'), 'url' => ['index']];
						...
						break;
	case 'search'	:	$this->params['breadcrumbs'][] = ['label' => Yii::t('mr42', 'Articles'), 'url' => ['index']];
						...
						break;
	default			:	$this->title = Yii::t('mr42', 'Articles');
endswitch;
