...
class VideoTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertSame($this->vimeoVideo, Video::getEmbed('vimeo', '5780260', '4by3'));
        $this->assertSame($this->youtubeVideo, Video::getEmbed('youtube', 'CdIenbh5Ju8', '4by3'));
        $this->assertSame($this->youtubePlaylist1, Video::getEmbed('youtube', 'PL6ugFMfi2vpN8uPV7OM2FMOlfF1nU2WJL', '16by9', true));
        $this->assertSame($this->youtubePlaylist2, Video::getEmbed('youtube', 'OLAK5uy_kFR3kL_3Zo2F8RmdtR0D55UC2vEwJukzM', '16by9', true));
    }

    public function testUrl(): void
    {
        $this->assertSame('https://vimeo.com/5780260', Video::getUrl('vimeo', '5780260'));
        $this->assertSame('https://vimeo.com/album/1539680', Video::getUrl('vimeo', '1539680', true));
        $this->assertSame('https://youtu.be/CdIenbh5Ju8', Video::getUrl('youtube', 'CdIenbh5Ju8'));
        $this->assertSame('https://www.youtube.com/playlist?list=PL6ugFMfi2vpN8uPV7OM2FMOlfF1nU2WJL', Video::getUrl('youtube', 'PL6ugFMfi2vpN8uPV7OM2FMOlfF1nU2WJL', true));
        $this->assertSame('https://www.youtube.com/playlist?list=OLAK5uy_kFR3kL_3Zo2F8RmdtR0D55UC2vEwJukzM', Video::getUrl('youtube', 'OLAK5uy_kFR3kL_3Zo2F8RmdtR0D55UC2vEwJukzM', true));
    }
}
