...
$this->beginBody();
	...
	echo Html::tag('p', 'Thank you for visiting '.Yii::$app->name);
	[$width, $height, $type, $attr] = getimagesize(Yii::getAlias('@assetsroot/images/mr42.png'));
	echo Html::a('<img src="'.$message->embed(Yii::getAlias('@assetsroot/images/mr42.png')).'" alt="'.Yii::$app->name.'" '.$attr.'>', Yii::$app->params['shortDomain']);
	echo Html::a(Yii::$app->params['shortDomain'], Yii::$app->params['shortDomain']);
$this->endBody();
